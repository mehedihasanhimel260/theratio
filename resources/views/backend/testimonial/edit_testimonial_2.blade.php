                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('all.testimonial_2') }}" class="btn btn-primary rounded-pill waves-effect waves-light"><i class="fe-arrow-left"></i>All Testimonials</a>                            
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       <p class="text-white" style="font-size: 20px">Testimonials Main Informantion</p>
                        ...
                        <form id="myForm" method="post" action="{{ route('testimonial_2.update') }}" enctype="multipart/form-data">
                            @csrf
