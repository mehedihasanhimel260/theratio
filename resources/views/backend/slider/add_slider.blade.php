                            ...
                            <div class="row">  
                                ...
                                <div class="col-lg-6 mt-2"> 
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="short_text_eng" class="form-control" id="" cols="30" rows="3" placeholder="Short Text in English ...">
                                      </textarea>
                                    </div>
                                </div> 
                                ...
                                <div class="col-lg-6 mt-2"> 
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="short_text_bng" class="form-control" id="" cols="30" rows="3" placeholder="Short Text in Bangla...">
                                        </textarea>                                      
                                    </div>
                                </div> 
