            ...
            <div class="row">
                <div class="col-lg-6 align-self-center mb-5 mb-lg-0">
                    <div class="contact-left">
                        ...
                        <form id="ajax-form" name="ajax-form" action="http://templates.thememodern.com/theratio/contact.php"
                            method="post" class="wpcf7">
                            <div class="main-form">
                                <p>
                                    <label for="name"> <span class="error" id="err-name">please enter
                                            name</span></label>
                                    <input type="text" name='name_english' value="" size="40" class=""
                                ...
                                <p>
                                    <label for="email">
                                        ...
                                        <span class="error" id="err-emailvld">e-phone is not a valid format</span>
                                    </label>
                                    <input type="text" name='phone' id="phone" value="" size="40"
                                        class="" aria-invalid="false" placeholder="Your phone *" required>
                                </p>
                                <p>
                                    <label for="message"></label>
                                    <textarea name='message_english' id="message" cols="40" rows="10" class="" aria-invalid="false"
                    ...
                    <div class="contact-right">
                        ...
                        <div class="list-social">
                            <ul>
                                ...
                                <li><a href="{{ $contact->facebook }}" target="_self"><i class="fab fa-facebook-f"></i></a>
                                </li>
                                <li><a href="{{ $contact->linkedIn }}" target="_self"><i
                                            class="fab fa-linkedin-in"></i></a>
                                </li>
                                <li><a href="{{ $contact->instagram }}" target="_self"><i
