...
@section('content')
    <div id="content" class="site-content">
        <div class="page-header dtable text-center header-transparent">
            <div class="dcell">
                <div class="container">
                    <h1 class="page-title">Project Single</h1>
                            ...
                            <div class="post-nav clearfix">
                                <div class="post-prev">
                                    @if (!empty($previousPost->main_image))
                                        <a href="{{ route('project.details', $previousPost->id) }}">
                                ...
                                <div class="post-next">
                                    @if (!empty($nextPost->main_image))
                                        <a href="{{ route('project.details', $nextPost->id) }}">
                    ...
                    <aside class="widget widget_recent_news">
                        ...
                        <ul class="recent-news clearfix">
                            @foreach ($blogs as $blog)
                                <li class="clearfix">
                                    <div class="thumb">
                                        <a href="{{ route('project.details', $blog->id) }}"><img
                                                src="{{ asset($blog->main_image) }}" alt=""></a>
                                    </div>
                                    <div class="entry-header">
                                        <h6><a
                                                href="{{ route('project.details', $blog->id) }}">{{ $blog->title_english }}</a>
                                        </h6>
